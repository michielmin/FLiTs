! TODO: this file is not used anymore and seems outdated, Check if something can still be usefull.
...
!=========================================================================================
! This subroutine reads in a forProDiMo.fits file generated by MCMax
! It fills the arrays:
! dens,T,kabs,kext,ksca,v,lam_cont,R,Theta
!=========================================================================================
subroutine ReadForProDiMo()
  ...
  character(len=7) :: vars(10), hdu
  real, allocatable :: array(:,:,:,:)
  real(kind=8), allocatable :: array_d(:,:,:,:)
  integer(kind=4) :: status, stat2, stat3, readwrite, unit, blocksize, nfound, group
  integer(kind=4) :: firstpix, nbuffer, npixels, hdunum, hdutype, ix, iz, ilam
  integer(kind=4) :: istat, stat4, tmp_int, stat5, stat6
  real :: nullval
  real(kind=8) :: nullval_d, xx, zz, rr
  ...
  do i = 3, nR-2
    ...
    if (R_av(i) < R(i) .or. R_av(i-1) > R(i)) then
...
!=========================================================================================
! This subroutine reads in a forFLiTs.fits file generated by MCMax
! It fills the arrays:
! dens,T,kabs,kext,ksca,v,lam_cont,R,Theta
!=========================================================================================
subroutine ReadMCMaxStructure()
  ...
  return
end subroutine ReadMCMaxStructure
